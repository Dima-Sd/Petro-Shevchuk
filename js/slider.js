           ...
           <article class="review__card">
             <div class="review__head">
               <img
                 ...
                 src="${escapeHtml(r.authorPhoto || "./images/Avatar-Placeholder@2x.png")}"
                 alt=""
                 loading="lazy"
                 onerror="this.style.background='#555'; this.src='./images/Avatar-Placeholder@2x.png';"
               />
 ...
 async function renderReviewSlides() {
   ...
   let reviews = [];
   try {
     const res = await fetch("../cache/reviews.json", { cache: "no-store" });
 ...
 function initReviewsSlider() {
  const wrapper = document.getElementById("reviewsWrapper");
   if (!wrapper) return; // на этой странице слайдера нет — тихо выходим
